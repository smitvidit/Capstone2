...
public class CreateAccountPage {
	...
	public String firstNameErrorField() {
		WebElement firstNameError_WebElement = wait
				.until(ExpectedConditions.visibilityOfElementLocated(firstNameError));
		return firstNameError_WebElement.getText();
	}

	public String lastNameErrorField() {
		WebElement lastNameError_WebElement = wait.until(ExpectedConditions.visibilityOfElementLocated(lastNameError));
		return lastNameError_WebElement.getText();
	}

	public String emailErrorField() {
		WebElement emailError_WebElement = wait.until(ExpectedConditions.visibilityOfElementLocated(emailError));
		return emailError_WebElement.getText();
	}

	public String passwordErrorField() {
		WebElement passwordError_WebElement = wait.until(ExpectedConditions.visibilityOfElementLocated(passwordError));
		return passwordError_WebElement.getText();
	}

	public String confirmPasswordErrorField() {
		WebElement confirmPasswordError_WebElement = wait.until(ExpectedConditions.visibilityOfElementLocated(confirmPasswordError));
		return confirmPasswordError_WebElement.getText();
	}
}